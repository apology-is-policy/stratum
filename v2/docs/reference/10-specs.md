...
+1 with P9-9P-0's `fid.cfg`).
All 61 buggy configs reproduce their designed invariant
...
- `IOOnlyAgainstCurrentGen` — for every captured `audit_io`
  ...
  /\ observed_alive)`. The headline staleness gate.
