...
## Remaining Phase 6 work (as of tip `ee45a0d`)

| Item | Status | Notes |
|---|---|---|
| Clone C impl (extends `stm_dataset_entry` with `origin_snap_id` + adds Create-clone + Promote APIs validating clone.tla; SnapWithClonesUndeletable wired via cb) | **Done at `ee45a0d`** | STM_UB_VERSION 9 → 10. Awaiting R32 audit close. |
