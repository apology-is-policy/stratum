...
int  stm_crypto_encrypt(struct stm_crypto *ctx, uint64_t a,
                        const void *p, uint32_t pl, void *c, uint32_t *cl)
    { (void)ctx;(void)a;(void)p;(void)pl;(void)c;(void)cl; return -ENOTSUP; }
int  stm_crypto_decrypt(struct stm_crypto *ctx, uint64_t a,
                        const void *c, uint32_t cl, void *p, uint32_t *pl)
    { (void)ctx;(void)a;(void)c;(void)cl;(void)p;(void)pl; return -ENOTSUP; }
